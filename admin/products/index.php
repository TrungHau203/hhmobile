...
<body>
	<?php 
		...
		if($contentProduct){
			...
			echo 'False';
			$sql="SELECT products.*, manufacturer.name as manufacturer_name from products INNER join manufacturer on products.id_manufacturer = manufacturer.id WHERE products.id_manufacturer in (select id from manufacturer)";
		}
